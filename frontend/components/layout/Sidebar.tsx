...
const navItems = [
  ...
  { href: "/video",      icon: "🎬", label: "Video Producer" },
  { href: "/playground", icon: "🎮", label: "AI Playground" },
  { href: "/analytics",  icon: "📊", label: "Analytics" },
  { href: "/contacts",   icon: "🔍", label: "Contact Finder" },
  { href: "/brand",      icon: "🎨", label: "Brand Templates" },
  { href: "/email",      icon: "💌", label: "Email Outreach" },
  { href: "/digital",    icon: "💾", label: "Digital Products" },
  { href: "/workflows",  icon: "🔧", label: "Workflows" },
  { href: "/calendar",   icon: "📅", label: "Calendar" },
  { href: "/journal",    icon: "📓", label: "Journal" },
  { href: "/customers",  icon: "👥", label: "Customers" },
  { href: "/files",      icon: "📁", label: "File Library" },
  { href: "/music",      icon: "🎵", label: "Music Platforms" },
  { href: "/browser",    icon: "🌐", label: "Browser-Use" },
  { href: "/jobs",       icon: "🔄", label: "Job Monitor" },
  { href: "/shortcuts",  icon: "⚡", label: "Shortcuts" },
